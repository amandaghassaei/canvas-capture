...
This project doesn't expose *all* the options of either CCapture.js or ffmpeg.wasm, but it packages them in a convenient way to be installed via npm and run on the browser (I'm mostly building with typescript + webpack).  I've also added:
